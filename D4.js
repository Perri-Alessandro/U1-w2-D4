...
const rettangolo = function (l1 = 0, l2 = 0) {
  return l1 * l2;
};
console.log("AREA DEL RETTANGOLO =", rettangolo(10, 5));
/* ESERCIZIO 2
...
console.log("IL TOTALE DI CRAZYSUM è:", crazySum(3, 3));
console.log("IL TOTALE DI CRAZYSUM è:", crazySum(1, 3));
/* ESERCIZIO 3
